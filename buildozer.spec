...
source.include_patterns = *.py, images/*.png, kivydata.db
...
requirements = python3, kivy==2.3.1, https://github.com/kivymd/KivyMD/archive/master.zip, exceptiongroup, asynckivy, asyncgui, materialyoucolor, android, pillow, plyer
